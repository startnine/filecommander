...
namespace RibbonFileManager.Adapters
{
    ...
    public class IMessageEventHandlerViewToContractAddInAdapter : System.AddIn.Pipeline.ContractBase, Start9.Api.Contracts.IMessageEventHandlerContract
    {
        ...
        {
            RibbonFileManager.Views.MessageReceivedEventArgs adaptedArgs;
            adaptedArgs = RibbonFileManager.Adapters.MessageReceivedEventArgsAddInAdapter.ContractToViewAdapter(args);
