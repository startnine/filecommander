...
namespace RibbonFileManager.Adapters
{
    ...
    {
        internal static RibbonFileManager.Views.IConfiguration ContractToViewAdapter(Start9.Api.Contracts.IConfigurationContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IConfigurationContract ViewToContractAdapter(RibbonFileManager.Views.IConfiguration view)
        {
            if ((view == null))
            {
                return null;
