...
namespace RibbonFileManager.Adapters
{
    ...
    {
        internal static RibbonFileManager.Views.IModuleInstance ContractToViewAdapter(Start9.Api.Contracts.IModuleInstanceContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IModuleInstanceContract ViewToContractAdapter(RibbonFileManager.Views.IModuleInstance view)
        {
            if ((view == null))
            {
                return null;
