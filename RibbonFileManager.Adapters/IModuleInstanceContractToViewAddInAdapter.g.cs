...
namespace RibbonFileManager.Adapters
{
    ...
    public class IModuleInstanceContractToViewAddInAdapter : RibbonFileManager.Views.IModuleInstance
    {
        ...
        public RibbonFileManager.Views.IModule Instance
        {
            get
            {
                return RibbonFileManager.Adapters.IModuleAddInAdapter.ContractToViewAdapter(_contract.Instance);
            }
        }
