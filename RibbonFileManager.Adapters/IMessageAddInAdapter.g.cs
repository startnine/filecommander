...
namespace RibbonFileManager.Adapters
{
    ...
    {
        internal static RibbonFileManager.Views.IMessage ContractToViewAdapter(Start9.Api.Contracts.IMessageContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IMessageContract ViewToContractAdapter(RibbonFileManager.Views.IMessage view)
        {
            if ((view == null))
            {
                return null;
