...
namespace RibbonFileManager.Adapters
{
    ...
    {
        internal static RibbonFileManager.Views.IConfigurationEntry ContractToViewAdapter(Start9.Api.Contracts.IConfigurationEntryContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IConfigurationEntryContract ViewToContractAdapter(RibbonFileManager.Views.IConfigurationEntry view)
        {
            if ((view == null))
            {
                return null;
