...
namespace RibbonFileManager.Adapters
{
    ...
    {
        internal static RibbonFileManager.Views.IMessageContract ContractToViewAdapter(Start9.Api.Contracts.IMessageContractContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IMessageContractContract ViewToContractAdapter(RibbonFileManager.Views.IMessageContract view)
        {
            if ((view == null))
            {
                return null;
